...
function send_email($email_recive, $name, $contents, $subject)
{
    ...
    $mail->Username   = "yennguyenthihvnn@gmail.com"; // Tên đăng nhập tài khoản Gmail
    $mail->Password   = "conlaumoinoi"; //Mật khẩu của gmail
...
send_email("nguyenvietlongvnua@gmail.com", "Nguyễn Việt Long", $contents, $subject);
